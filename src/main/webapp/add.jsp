...
<html>
	...
	<body>
		...
		<div class="container">
			<form id="addBookForm" action="/addBookServlet" method="post" class="form-horizontal">
				<fieldset id="">
					<legend>添加图书</legend>
					<div class="form-group">
						<label for="bookNameInput" class="col-sm-2 control-label">书名:</label>
						<div class="col-sm-10">
							<input type="text" name="bookName" id="bookNameInput" class="form-control" />
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="press" id="pressInput" class="form-control" />						
						</div>
					</div>
					<div class="form-group" >
					...
					<div id="buttons" class="row">
						...
						<button id="sendicrect" type="button" class="btn btn-info col-sm-1"><a id="a" href="/findBooksServlet">返回</a></button>
					</div>
